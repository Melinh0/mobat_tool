"""
Django settings for mobat_tool project.
...
SECRET_KEY = 'django-insecure-=n9nu&v77_9d3_--fr_nm2whcrialvl=ri#+1c(1&wq%=@yr02'
...
WSGI_APPLICATION = 'mobat_tool.wsgi.application'
